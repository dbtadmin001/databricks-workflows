# Workflow - NBA Analytics Platform
...
- `P13-M00`: preflight, source profile, environment and contracts.
- `P13-M01`: complete Bronze, Silver, quarantine, Gold and WAP MVP.
- `P13-M02`: one review pass and prioritized hardening.
- `P13-M03`: documented PR and automated dev/production delivery evidence.
